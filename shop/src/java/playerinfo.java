...
public class playerinfo extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        y=request.getParameter("city");
        z=request.getParameter("ssn");
        ...
        try
            ...
            stmt.executeUpdate("insert into playerdetes values('"+x+"','"+y+"','"+z+"')");
            //out.println("<center><h1>Player cntinue</h1>");
        ...
        catch(Exception e)
        {
            ...
            RequestDispatcher rs = request.getRequestDispatcher("failure.jsp");
            rs.include(request, response);
        }
